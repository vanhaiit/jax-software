                                                      ...
                                                      <tbody>
                                                          <tr>
                                                              <td align="left" valign="middle" width="50%"><span
                                                                      style="margin:0;color:#4c4c4c;white-space:normal;display:inline-block;text-decoration:none;font-size:12px;line-height:20px">Jix Software</span>
                                                              </td>
                                                              <td valign="middle" width="50%" align="right"
                                                                  style="padding:0 0 0 10px"><span
                                                                      style="margin:0;color:#4c4c4c;white-space:normal;display:inline-block;text-decoration:none;font-size:12px;line-height:20px">Thư
                                                                      tự động !</span></td>
                                                              <td width="1">&nbsp;</td>
                                                          </tr>
                                                      </tbody>
                                                                                          ...
                                                                                          <tr>
                                                                                              <td align="center" width="100%">
                                                                                                  <h1
                                                                                                      ...
                                                                                                      Thông tin cập nhật công việc</h1>
                                                                                              </td>
                                                                                          </tr>
                                                                                      </tbody>
                                                                                  </table>
                                                                                          ...
                                                                                          <tr>
                                                                                              <td align="center" width="100%"
                                                                                                  ...
                                                                                                  <h3 style="font-weight: 600; padding: 0px; margin: 0px; font-size: 16px; line-height: 24px; text-align: center;"
                                                                                                      class="title-color">Cập nhật công việc ${data.name}</h3>
                                                                                                  ${Object.keys(data.value).length === 1 ? ` <p
                                                                                                  style="margin: 20px 0 30px 0;font-size: 15px;text-align: center;">
                                                                                                  <div style="font-weight: 200; text-align: center; margin: 25px;"><a style="padding:0.6em 1em;border-radius:600px;color:#ffffff;font-size:14px;text-decoration:none;font-weight:bold" class="button-color">${data.user.UserName}</a></div>
                                                                                                  <h3 style="font-weight: 600; padding: 0px; margin: 0px; font-size: 16px; line-height: 24px; text-align: center;"
                                                                                                  class="title-color">Cập nhật công việc về ${data.value.Status === 0 ? 'Chờ xử lý' : data.value.Status === 1 ? 'Đang xử lý' : data.value.Status === 2 ? 'Đã hoàng thành' : ''}</h3>
                                                                                                  
                                                                                              </p>` : `  <p
                                                                                              style="margin: 20px 0 30px 0;font-size: 15px;text-align: center;">
                                                                                              <div style="font-weight: 200; text-align: center; margin: 25px;"><a style="padding:0.6em 1em;border-radius:600px;color:#ffffff;font-size:14px;text-decoration:none;font-weight:bold" class="button-color"> ${data.user.UserName}</a></div>
                                                                                              <h3 style="font-weight: 600; padding: 0px; margin: 0px; font-size: 16px; line-height: 24px; text-align: center;"
                                                                                              class="title-color">Giao việc lại cho</h3>
                                                                                              <div style="font-weight: 200; text-align: center; margin: 25px;"><a style="padding:0.6em 1em;border-radius:600px;color:#ffffff;font-size:14px;text-decoration:none;font-weight:bold" class="button-color" >${data.subuser.UserName}</a></div>
                                                                                          </p>`}
                                                                                              </td>
                                                                                          </tr>
                                                                                      </tbody>
                                                                      ...
                                                                      <tbody>
                                                                          <tr>
                                                                              <td align="center" valign="middle" width="100%"
                                                                                  ...
                                                                                  ...♦...
                                                                                  <br><b>Cảm ơn bạn đã sử dụng dich vụ của
                                                                                      chúng tôi !</b>
                                                                              </td>
                                                                          </tr>
                                                                      </tbody>
